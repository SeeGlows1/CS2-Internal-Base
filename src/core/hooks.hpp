...
namespace hooks {
	...
	using function_preset = HRESULT(__stdcall*)(IDXGISwapChain*, UINT, UINT);
	inline function_preset original_present = nullptr;

	using function_resize_buffers = HRESULT(__stdcall*)(IDXGISwapChain*, UINT, UINT, UINT,
															DXGI_FORMAT, UINT);
	inline function_resize_buffers original_resize_buffers = nullptr;

	using function_create_swap_chain = HRESULT(__stdcall*)(IDXGIFactory*, IUnknown*,
